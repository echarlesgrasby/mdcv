...
\begin{itemize}
	\item First Orion is an Arkansas-based software company that provides call transparency and enhancement solutions for the telcommunications industry.
 \begin{itemize}
  \item Work with a team of DevOps Engineers to manage a large infrastructural codebase for the AWS platform using Hashicorp Terraform.
 \end{itemize}
\end{itemize}
\\
