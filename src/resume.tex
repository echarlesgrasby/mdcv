...
\begin{document}
    ...
    \section{Profile}
        ...
        \begin{onecolentry}
            I am a team-oriented developer and technology generalist with over 10 years of experience, across several industries and problem domains. My programming expertise ranges across multiple layers of the modern application stack, including back-end development, UI development, cloud infrastructure (AWS), and custom data processing code.

            \vspace{0.25 cm}
            
            I also have experience in data modeling, requirements analysis, and technical writing. My current passion is pursuing my Ph.D. in Computer and Information Science. My dissertation focuses on information quality and language engineering. \textit{I am currently based in Little Rock, AR, but I am very open both to remote work opportunities and relocation.}
        \end{onecolentry}
